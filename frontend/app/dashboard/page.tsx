    ...
    <div className="dashboard">
        ...
        <table className="attackers-table">
          ...
          <tbody>
            {attackers.slice(0, 5).map((a, i) => (
              <tr key={i}>
                <td className="ip">
                  <Link href={`/investigate?ip=${a.ip}`}>{a.ip}</Link>
                </td>
      ...
      <div className="chart-card">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          ...
          >
            <b>System Risk Level:</b>{' '}
            <span style={{ color: '#f97316' }}>
              {stats.criticalAlerts > 5
                ? 'CRITICAL'
          ...
          >
            ...
            {stats.criticalAlerts > 0
              ? 'Investigate top attacker IPs immediately'
              : 'Continue monitoring'}
          </div>
        </div>
      </div>
          ...
          >
            ...
            <button
              ...
              onClick={async (e) => {
                e.stopPropagation();
                try {
                  const res = await apiFetch('/logs/ai-explain', {
                    method: 'POST',
      ...
      <div className="chart-card">
        ...
        {!aiInsight ? (
          <p className="muted">Click any attack to analyze...</p>
        ) : (
          <div
            style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}
          >
            <div className="ai-box">
              <b>Type:</b> {aiInsight.type}
            </div>
            ...
            <div className="ai-box">
              <b>Explanation:</b> {aiInsight.explanation}
            </div>

            <div className="ai-box">
              <b>Recommended Action:</b> {aiInsight.action}
            </div>
          </div>
        )}
      </div>
